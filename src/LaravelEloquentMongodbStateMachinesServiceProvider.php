...
use Izoniks\LaravelEloquentMongodbStateMachines\Commands\MakeStateMachine;

class LaravelEloquentMongodbStateMachinesServiceProvider extends ServiceProvider
{
